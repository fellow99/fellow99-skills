...
> - UIAbility 指南: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-uiability
> - Navigation 组件: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-navigation-navigation
...
> **注意**：本节为快速参考。完整的状态管理和数据持久化方案请参考：
> - 应用级响应式状态：[`state-management.md`](state-management.md) 的 AppStorage / PersistentStorage 章节
> - 数据持久化方案对比：[`data-persistence.md`](data-persistence.md)
